...
//	@NamedQuery(name = Compra.TODOS_PRODUCTOS_COMPRA,query = "select d.productoCompra from Compra c inner join c.detalleCompra d where c.codigo = :codigo")
})
@Table(name = "Compras")
public class Compra implements Serializable {

	public static final String TODAS_COMPRAS = "TODAS_COMPRAS";
	public static final String TODOS_PRODUCTOS_COMPRA = "TODOS PRODUCTOS COMPRA";
	@Id
